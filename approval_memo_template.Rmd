...
ou_name<-getOrgtunitNamefromUID(input$ou, user_input$httr_handle)
...
kable(d$prio, "latex", 
      booktabs = T,
      longtable = F,caption = "Prioritization Table") %>%
  add_header_above(c("Angola"=2,"SNU Prioritizations" = 7),background ="#CCC0D9", bold = TRUE ) %>%
