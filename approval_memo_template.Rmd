...
#PP_PREV-> Prep_CURR
kable(d$partners[,c(1:2,26:35)], "latex", booktabs = T, longtable=T,format.args = list(big.mark = ","),
 ...
 cat('\n\n')
  ...
  kable(d$partners[,c(1:2,36:44)], "latex", booktabs = T, longtable=T,format.args = list(big.mark = ","),
